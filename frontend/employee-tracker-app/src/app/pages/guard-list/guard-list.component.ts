...
@Component({
  ...
  imports: [MatButtonModule, MatFormFieldModule, MatInputModule, MatTableModule, CommonModule, FormsModule, MatCardModule],
...
export class GuardListComponent implements OnInit { 
  ...
  constructor(private guardsService: GuardsService, private http: HttpClient, private router: Router){}
