...
@Component({
  selector: 'app-home',
  imports: [CommonModule,FormsModule,MatTableModule,MatCardModule,MatButtonModule,MatIconModule],
...
constructor(private guardsService: GuardsService, private auth: Auth, private router: Router){}
...
async submitReport(){
  ...
  try{
    ...
    await firstValueFrom(this.http.put(`http://localhost:3000/api/guards/${this.selectedGuardId}/${endpoint}`, body,
