...
export class AccessService {
    ...
    private roleSubject = new BehaviorSubject<Role | null>(localStorage.getItem('role') as Role || null);
  ...
  addAllow(email: string, role: Role) {
    return this.http.post<AllowedEmailRow>(`${this.base}/allowlist`, { email, role }, this.headers());
  }
